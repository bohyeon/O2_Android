...
//      String text = "오투스포츠";
//      String imageUrl = "https://lh3.googleusercontent.com/zBKh2QAZIvcwly-QRQJGFnXLJ1eFudXMX_T3elhPwWpVqcft6z6Qu59E--pCqswZJmdV=w300-rw";
//      int imageWidth = 100;
//      int imageHeight = 100;
//      String buttonText = "앱으로 이동하기";
//
//      try {
//          kakaoTalkLinkMessageBuilder
//                  .addText("O2 SPORT 초대코드 : " + invite_code_kakao)
//                  .addImage(imageUrl, imageWidth, imageHeight)
//                  .addAppButton(buttonText)
//                  .build();
//          kakaoLink.sendMessage(kakaoTalkLinkMessageBuilder.build(), inviteActivity);
//      } catch (KakaoParameterException e) {
//          e.printStackTrace();
//
//      }
//
      String invite_code_kakao = invite_code;
        try {
           ...
           kakaoTalkLinkMessageBuilder.addText("[O2 SPORT 초대 코드]\n" + invite_code+"\n\n>앱으로 이동하기 : https://goo.gl/LKpNqi");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(resultCode == RESULT_OK)
        {
            ...
            smsManager.sendTextMessage(number, null, "O2 SPORT 초대 코드 : " + invite_code + "\n앱으로 이동하기 : https://goo.gl/LKpNqi", null, null);
                ...
                for (int i = 0; i < permissions.length; i++) {
                    ...
                    if (permission.equals(Manifest.permission.SEND_SMS)) {
                        if (grantResult == PackageManager.PERMISSION_GRANTED) {
                            ...
                            SmsManager smsManager = SmsManager.getDefault();
                            smsManager.sendTextMessage(number, null, "O2 SPORT 초대 코드 : " + invite_code + "앱으로 이동하기 : https://goo.gl/LKpNqi", null, null);
                            Toast.makeText(getApplicationContext(), "초대코드 발송완료!",
                                    Toast.LENGTH_LONG).show();
                        } else {
