...
public class MenteeMemberAdapterActivity extends ArrayAdapter<NewsfeedItem> {
    ...
    MenteeMemberAdapterActivity newsfeedAdapterActivity;
    ...
    public MenteeMemberAdapterActivity(Context context, NewsFeed newsFeed, MemberActivity memberActivity) {
