...
//        Log.d("response" , "sport type 0 : " + loginPreferences.getString("member_type","").toString());
        ...
        if(loginPreferences.getString("member_type","").equals("mentee")){
            ...
            List<String> strings = Arrays.asList("종목선택","축구","야구","농구","배구","탁구","테니스","역도","유도","태권도","복싱","레슬링","승마","체조","육상","펜싱","요트","조정","사격","하키","핸드볼","근대3종","철인3종","배드민턴","정구","골프","싸이클","수영","럭비","씨름","보디빌딩","봅슬레이,루지,스켈레톤","바이애슬론","스키,스노우보드","아이스하키","컬링","빙상","공수도","양궁","볼링","검도","롤러","세팍타크로","소프트볼","스쿼시","기타");
