...
//
//                    Intent intent1 = new Intent(SearchActivity_old.this, SearchFeedActivity.class);
...
//
//            Intent intent = new Intent(SearchActivity_old.this, SubjectFeedActivity.class);
//            startActivity(intent);
//
//        } else if (id == R.id.nav_slideshow) {
//
//            Intent intent = new Intent(SearchActivity_old.this, ExpertFeedActivity.class);
//            startActivity(intent);
//
//        } else if (id == R.id.nav_manage) {
//
//            Intent intent = new Intent(SearchActivity_old.this, NewsfeedWriteActivity.class);
//            startActivity(intent);
//
//        } else if (id == R.id.nav_share) {
//
//            Intent intent = new Intent(SearchActivity_old.this, NoticeActivity.class);
//            startActivity(intent);
//
//        } else if (id == R.id.nav_send) {
//
//            Intent intent = new Intent(SearchActivity_old.this, MypageActivity.class);
//            startActivity(intent);
//
//        } else if (id == R.id.people) {
//
//            Intent intent = new Intent(SearchActivity_old.this, MemberActivity.class);
//            startActivity(intent);
//
//        }
//
