...
public class SearchfeedAdapterActivity extends ArrayAdapter<NewsfeedItem> {

    LayoutInflater layoutInflater;
    NewsFeed newsFeed;
    SearchFeedActivity expertFeedActivity;
    Context context;
    NewsfeedItem newsfeedItem;
    SearchFeedActivity searchFeedActivity;
    ImageView image, profile_img;
    SearchfeedAdapterActivity newsfeedAdapterActivity;
    ...
    public SearchfeedAdapterActivity(Context context, NewsFeed newsFeed, SearchFeedActivity expertFeedActivity) {
            ...
            if(newfeedItemPosition.youtube_id == null || newfeedItemPosition.youtube_id.equals("")){
                ...
                if(!newfeedItemPosition.youtube_id.equals("") ){
                  ...
                  //  Log.d("response", "youtube ㅅㅂ : " + newfeedItemPosition.youtube_id);
                    ...
                    LinearLayout.LayoutParams parms = new LinearLayout.LayoutParams(width,height);
                    viewHolder.youtube_title.setLayoutParams(parms);
                    viewHolder.youtube_title.setText("서버에서 타이틀이 오길 기다리는중");
                    viewHolder.youtube_img.setLayoutParams(parms);
            ...
            if(newsFeed.newsfeedItem.size() != 0){
                ...
                if(newfeedItemPosition.youtube_id == null || newfeedItemPosition.youtube_id.equals("")){
                    ...
                    if(!newfeedItemPosition.youtube_id.equals("") ){
                        ...
                        viewHolder.youtube_layout.setBackground(null);
                        Log.d("response", "youtube ㅅㅂ : " + "http://img.youtube.com/vi/"+newfeedItemPosition.youtube_id+"/1.jpg");
                        youtube_link = newfeedItemPosition.youtube_link;
